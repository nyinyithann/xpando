...
describe('mapFoldRight()', () => {
  test('should throw error for invalid args', () => {
    ...
    expect(() => mapFoldRight.call(null)).toThrow(TypeError);
    expect(() => mapFoldRight.call(new Vec(1, 2), null, 1)).toThrow(TypeError);
    expect(() => mapFoldRight.call(new Vec(1, 2), function* () {}, 1)).toThrow(TypeError);
  });
